...
public class CHTCollectionViewWaterfallLayout: UICollectionViewLayout {
    ...
    public struct Constants {
        ...
        static let contentLineSpacing: CGFloat = 20
        static let collectionColumnNum: Int = 2
    ...
    override public init() {
        ...
        self.columnCount = Constants.collectionColumnNum
        self.minimumInteritemSpacing = Constants.itemSpacing
        self.minimumColumnSpacing = Constants.columnSpacing
